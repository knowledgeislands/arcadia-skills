...
import { scenarios as kbScenarios } from './scenarios/ki-repo-kb.ts'
import { scenarios as mcpScenarios } from './scenarios/ki-repo-mcp.ts'
...
import { scenarios as repoRoadmapScenarios } from './scenarios/ki-change-management-roadmap.ts'
import { scenarios as activitiesScenarios } from './scenarios/ki-repo-kb-activities.ts'
import { scenarios as liveArtifactsScenarios } from './scenarios/ki-repo-kb-live-artifacts.ts'
