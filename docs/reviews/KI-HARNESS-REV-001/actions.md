...
| --- | --- | --- | --- |
| `ACCEPT-REV-001` | Close the review. | [REV-001](../../roadmap/KI-HARNESS-REV-001-review-skill-effectiveness.md) | Done |
| `RENAME-KI-WORK` | Rename the parent. | [GOV-039](../../roadmap/KI-HARNESS-GOV-039-rename-change-management.md) | Now, draft |
| `DECIDE-KB-AUTHORITY` | Choose KB metadata and principal authority. | [GOV-040](../../roadmap/KI-HARNESS-GOV-040-resolve-kb-authority.md) | Next, draft |
| `DECIDE-SPECS-IDENTITY` | Choose Specification identity and activation. | [GOV-041](../../roadmap/KI-HARNESS-GOV-041-resolve-specification-identity.md) | Next, draft |
