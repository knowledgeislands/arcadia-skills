...
- [Generated write boundaries](generated-write-boundaries.md) — ownership and recovery for vendored governance, runtime copies, links, and command wiring.
- [Retiring repository-vendored KI](retiring-repository-vendored-ki.md) — the maintainer-only, guide-led procedure for moving an existing KI repository from `.ki/` to native `ki` operations.
