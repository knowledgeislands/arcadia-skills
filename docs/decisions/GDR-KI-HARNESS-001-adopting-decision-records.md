...
- A repository adopting Decision Records declares `["knowledgeislands/ki-agentic-harness:ki-decision-records"]` in `.ki.toml` and carries GDR001 as its first governance decision.
