...
4. Update the standard and family definitions where evidence changed, regenerate with `ki dev skill rubric ki-plugins --write`, and bump the source review dates.
