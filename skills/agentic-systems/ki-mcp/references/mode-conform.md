...
_On-demand procedure for ki-mcp's CONFORM mode. Hosted conform is intentionally limited to bounded edits of existing regular configuration files; generated clients and repository commands remain explicit._
