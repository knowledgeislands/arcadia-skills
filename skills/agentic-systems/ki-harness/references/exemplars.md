...
When the physical file already exists and only `[skills.ki-harness]` is missing, CONFORM may append that marker. Missing or unsafe configuration remains a reported manual case.
