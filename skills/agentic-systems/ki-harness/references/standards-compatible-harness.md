...
A source harness carries `ROADMAP.md` as its open-work register. The `ki-roadmap` skill owns roadmap profiles, horizon vocabulary, generated projections, and content discipline; this standard checks only the root file's physical presence.
...
| Repository roadmap content                   | `ki-roadmap`     |
