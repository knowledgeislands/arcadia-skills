...
- **FILES-4 [M] — Runtime skill ignore contract** — Generated Claude and Codex runtime skill links are ignored while the repository-owned .agents/skills/ki-self source remains committed. (standards-repository.md)
