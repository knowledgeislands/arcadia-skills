...
const ITEMS = [
  ...
  mechanicalItem(
    ...
    'Derived .ki audit and conform artifacts are ignored rather than committed.',
    'WARN'
  ),
  mechanicalItem(
    'FILES-3',
  ...
  mechanicalItem('VENDOR-1', 'Vendored payload integrity', 'Manifest-listed .ki payloads exist and match their recorded hashes.', 'FAIL', [
    'WARN'
  ]),
  mechanicalItem(
    'CAPABILITY-COMPLETE',
