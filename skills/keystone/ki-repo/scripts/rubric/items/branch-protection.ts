...
const BP_1: RubricItem<EvidenceRubricContext> = {
  ...
  description: 'Main has the configured branch-protection posture, including required PR, build check, and linear history when enabled.',
  sources: ['standards-repository.md'],
  mechanical: {
    level: 'FAIL',
    remediation: { class: 'diagnostic', guidance: 'Configure the required branch-protection posture or record an explicit override, then rerun the audit.' },
