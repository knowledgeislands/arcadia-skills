...
const COV_1: RubricItem<EvidenceRubricContext> = {
  ...
  description: 'Detected governance applicability and declared opt-in tables agree, subject to explicit coverage overrides.',
  sources: ['standards-configuration.md'],
  mechanical: {
    level: 'WARN',
    remediation: {
      class: 'diagnostic',
      guidance: 'Align the declared coverage table with detected applicability or record an explicit override, then rerun the audit.'
    },
