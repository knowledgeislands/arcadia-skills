...
- **KI-SHAPE-1 [J] — standard skills resolve base bindings at runtime** — A **standard** KI skill resolves base bindings at runtime and hard-codes **no single base**. (ki-agentic-harness README, `ki-repo-kb`)
  - _Evidence scope:_ The target skill and the evidence named by this criterion.
