...
- **The `[ki-subagents]` gate** — if agent discovery locations (`.claude/agents/`) or precedence change, re-anchor the project publisher's agent-link behaviour alongside [CS].
