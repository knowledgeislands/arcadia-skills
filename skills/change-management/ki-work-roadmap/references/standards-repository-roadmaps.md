...
- **Waiting:** confirm that each `waiting_on_trades` identity names an existing relevant trade and that the prose names its precise observed condition without treating the trade as a local dependency.
