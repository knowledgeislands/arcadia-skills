...
# Generated rubric — Linear change-management adapter

> **Generated publication.** The TypeScript rubric items under `scripts/rubric/items/` are canonical. Edit those definitions, then rerun `ki dev skill rubric ki-change-management-linear --write`.

Line-by-line criteria for auditing ki-change-management-linear. Classifications are derived from item aspects: **[M]** mechanical, **[J]** judgment, **[M + J]** hybrid, and **[M-heuristic + J]** hybrid with heuristic mechanical evidence. Sources are cited as declared by each canonical item.
...
One declared Linear team with matching shared selection.
