...
The portable contract separates repository-owned reconstruction state from vendor session continuity. It retains the proven flat active snapshot while replacing timestamped checkpoint accumulation with explicit retirement and Git history.
