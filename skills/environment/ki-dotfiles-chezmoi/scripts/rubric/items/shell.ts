...
const SHELL_J1: RubricItem<ReviewContext> = {
  ...
  judgment: {
    ...
    guidance: 'Make paths idempotent and ordered, guard optional integrations, and regenerate tracked completions through their documented upstream CLI generator.'
  }
}
