...
_On-demand procedure for ki-homebrew-tap's REFRESH mode. The cadence and source list are declared in [`sources.md`](sources.md). The full standard lives in [`standards.md`](standards.md)._
