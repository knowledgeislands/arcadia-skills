...
- [AH] — The harness `CLAUDE.md` five-part table still reads "16 ki-* skills" against an actual 18 (a repo-CLAUDE.md freshness matter, not a standard change) — flagged for central handling.
