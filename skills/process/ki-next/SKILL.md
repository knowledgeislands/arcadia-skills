...
4. **Select** eligible, dependency-ready immediate work first: Blocking and Next in a non-KB repository; Blocking and Active in a Knowledge Base. It promotes later work only after confirmation and re-evaluates it at the destination.
...
- No roadmap, plan, Stream, or proposal write occurs until the user explicitly confirms the selected item, order, wording, and horizon or Focus transition. Rejected proposals leave the files untouched.
