...
| `ki-roadmap` — non-KB roadmaps and plan format | IN-HOUSE | The host artifact in a non-KB repository; the base quality bar | 2026-07-16 |
...
- **REFRESH last run 2026-07-04** — internal-model pass (no web research), skill audited against itself.
  ...
  - _Confirmed_ `ki-roadmap`: a thematic plan is still the dependency-ordered record that survives context resets and handoffs — host-artifact role in a non-KB repository unchanged.
