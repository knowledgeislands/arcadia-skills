...
const ADOPTION_1: RubricItem<TradeJudgmentContext> = {
  ...
  sources: [SOURCE],
  judgment: {
    scope: 'Every receiver disposition and any proposed direct application, local adoption, or knowledge retention following it.',
    prompt:
    ...
    guidance: 'Keep the trade decision separate from local prioritisation and acceptance; create or link local work only through its own confirmed lifecycle.'
  }
}
