...
import type { FeatureAreaContext, FeatureDefinitionsRubricContext } from '../contexts/feature-definitions.ts'
...
export const AREA: RubricFamily<FeatureDefinitionsRubricContext, FeatureAreaContext> = {
  code: 'AREA',
