...
The delegation standard was separated from the execution process so its durable packet can be audited without claiming dispatch authority or confusing it with a cross-repository trade.
